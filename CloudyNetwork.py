...
class CloudyNetwork(object):
    ...
    def main(cls, args):
        ...
        given1[rain]= True
        given1[cloudy]=True
        print("rejection sampling: " +str(cloudnet.performRejectionSampling(wetGrass, given1, 99999)))
        ...
        given2 = {}
        given2[rain]=True
        print("rejection sampling: " + str(cloudnet.performRejectionSampling(sprinkler, given2, 99999)))
